...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with studio_tabs[3]:
        ...
        if not video_enabled:
            ...
            # Image background options — web search always available (Google Images needs no key)
            bg_options = ["Plain slides", "Web image search"]
            ...
            bg_option = st.radio(
                ...
                help=(
                    ...
                    f"**Web image search**: Search {provider_hint} for relevant photos (no API key needed). "
